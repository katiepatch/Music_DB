...
class PlaylistsControllerTest < ActionController::TestCase
  ...
  test "should create playlist" do
    assert_difference('Playlist.count') do
      post :create, playlist: { artist_id: @playlist.artist_id, name: @playlist.name, song_id: @playlist.song_id }
    end
  ...
  test "should update playlist" do
    patch :update, id: @playlist, playlist: { artist_id: @playlist.artist_id, name: @playlist.name, song_id: @playlist.song_id }
    assert_redirected_to playlist_path(assigns(:playlist))
  end
